...
const TestSeriesCard = ({ setIsTestDetails }) => {
  return (
    <div className="w-full   group relative rounded-lg" onClick={()=>setIsTestDetails(true)} >
        ...
        <div className="  border border-t-0 bg-white border-gray3 rounded-b-lg ">
         ...
         <div className="text-[10px] md:text-xs lg:text-sm font-medium !leading-[63%]" >Pathfinder</div>
         <div className="pt-2 sm:pt-2.5 pb-2 text-base md:text-lg lg:text-[22px] font-bold tracking-[0.22px] !leading-[63%]">UP Constable</div>
         <div className="text-[10px] md:text-xs lg:text-sm font-medium !leading-[63%]">Exam 2024</div>
         <div className="pt-3 sm:pt-4 flex items-center">
        <div className="px-3 sm:px-5 py-1.5 sm:py-2 bg-black text-white text-[11px] md:text-xs lg:text-sm font-bold rounded-l-full !leading-[63%]">35</div>
        <div className="p-1.5 sm:px-3 sm:py-2 bg-gray4  text-[11px] md:text-xs lg:text-sm font-medium rounded-r-full !leading-[63%]">Total Test</div>
         </div>
         <div className="pt-2 sm:pt-5 pb-2 sm:pb-3 flex items-center justify-between gap-1 sm:gap-2">
           <div className="text-[11px] sm:text-xs md:text-sm text-nowrap lg:text-base font-medium text-primary2/70 !leading-[63%]">Attempt a test for free</div>
           ...
           <img className="max-md:[filter:brightness(8)contrast(1)] md:hover:[filter:brightness(8)contrast(1)] transition-all ease-in-out duration-300" src={toDoArrow} alt="" />
           </div>
        </div>
          ...
          <div className="flex items-center gap-2.5 sm:gap-4  text-sm lg:text-base">
            <div className="line-through font-medium  !leading-[63%]">Rs.265</div>
        ...
        <div className="flex items-center gap-1 md:gap-2 ps-2.5 sm:ps-5 pe-2 sm:pe-4 pb-2.5 sm:pb-[18px] ">
          <button className="group/cart md:hover:text-white md:hover:bg-black md:hover:rounded-sm max-md:rounded-[4px] flex border border-b-black border-gray3 px-0.5 sm:px-1.5  items-center justify-center w-full gap-0.5 sm:gap-1  text-[9px] md:text-xs lg:text-sm font-semibold max-md:py-2 py-1 duration-300 transition-all ease-in-out text-primary2 !leading-[63%]">
          <img className="size-2 md:size-2.5 lg:h-[13px] lg:w-[14px] md:group-hover/cart:[filter:brightness(9)contrast(1)] duration-300 transition-all ease-in-out " src={cartIcon} alt="" />
          <div className="text-nowrap">Add to cart</div>
          </button>
          <button className="group/cart max-md:bg-black max-md:text-white md:hover:text-white md:hover:bg-black md:hover:rounded-sm max-md:rounded-[4px] flex border border-b-black border-gray3 px-0.5 sm:px-1.5  items-center justify-center w-full gap-0.5 sm:gap-1  text-[9px] md:text-xs lg:text-sm font-semibold max-md:py-2 py-1 duration-300 transition-all ease-in-out text-primary2 !leading-[63%]">
          <img className="size-2 md:size-2.5 lg:h-[14px] lg:w-[14px] max-md:[filter:brightness(9)contrast(1)] md:group-hover/cart:[filter:brightness(9)contrast(1)] duration-300 transition-all ease-in-out" src={bag} alt="" />
