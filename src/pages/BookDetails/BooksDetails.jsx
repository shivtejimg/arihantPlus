...
const BooksDetails = () => {
  ...
  return (
    <AppLayout>
      ...
      <div className="max-w-6xl 2xl:w-full 2xl:max-w-full 2xl:px-40  px-6 mx-auto pt-4 ">
        <div className="flex items-center">
          <Link
            className="text-[10px] sm:text-sm 2xl:text-2xl font-medium text-gray1 inline-block"
            to={PAGE_ROUTES.HOME}
          >
            Home
          </Link>
          <span className="px-1 text-[10px] sm:text-sm 2xl:text-2xl font-medium text-black inline-block">
            /
          </span>
          <Link className="text-[10px] sm:text-sm 2xl:text-2xl font-medium text-gray1">
            Jee & Other Eng Entrances
          </Link>
          <span className="px-1 text-[10px] sm:text-sm 2xl:text-2xl font-medium text-black inline-block">
            /
          </span>
          <Link className="text-[10px] sm:text-sm 2xl:text-2xl font-medium text-black">
        ...
        <div className="mt-10">
          <div className=" justify-between items-center max-md:flex hidden">
            <p className="font-semibold text-lg lg:text-xl 2xl:text-3xl  text-black">
              {data?.heading}
            </p>
            <img
              src={shareIcon}
          ...
          {data?.subheading ? (
            <p className="text-sm lg:text-base text-black font-semibold max-md:block hidden pb-6">
              {" "}
              ({data?.subheading})
            </p>
          ) : (
          ...
          <div className="grid grid-cols-12 mb-2 items-start gap-4 sm:gap-6 lg:gap-8">
            <div className="col-span-7 sm:col-span-4 md:col-span-3 ">
              <div className=" *:size-full flex justify-center *:object-cover mb-3">
              ...
              {/* <div className="grid-cols-3 gap-4 grid justify-center">
                ...
                >
                  <div className="p-1 bg-white border h-16 w-full flex justify-center items-center border-gray2">
              ...
              <div className="relative">
                ...
                <div className="grid grid-flow-col gap-4">
                  <ErrorBoundary>
                    <div className="p-1 bg-white border h-16 w-full flex justify-center items-center border-black rounded-md px-4"
                      onClick={() => setShowModalVideo(true)}>
                      <div>
                        <div className="size-9 bg-red1 *:size-5 rounded-full flex justify-center items-center h-9 pl-1">
                          <img src={whitebtn} alt="" />
                        </div>
                      </div>
                    </div>
                  ...
                  <ErrorBoundary>
                    <div
                      className="p-1 bg-white border h-16 w-full flex justify-center items-center border-black rounded-md px-2"
                      onClick={() => setShowModal(true)}
                    >
                      <div>
                        <p className="text-xs font-semibold text-center text-black">
                  ...
                  <ErrorBoundary>
                    <div className="bg-gray1 border p-1 h-16 w-full flex justify-center items-center border-black rounded-md px-3">
                      <div>
                        <p className="text-[9px] font-semibold text-center text-white">
                          Be an IITian Go Crack it!
                        </p>
                ...
                <div className="mt-[26px] flex w-full justify-center" >
                  <button className="bg-gray1 text-white rounded-full px-[28.5px]  pt-[11px] pb-[8px] font-Isidora_Sans font-semibold text-base" onClick={()=>setPdfPreview(true)} >Read Sample</button>
                </div>
              </div>
            </div>
            <div className="col-span-5 sm:col-span-8 md:col-span-5 lg:col-span-6">
              ...
              {data?.subheading ? (
                <p className="text-sm lg:text-base text-black font-semibold max-md:hidden">
                  {" "}
                  ({data?.subheading})
                </p>
              ) : (
              ...
              <p className="text-base md:text-sm lg:text-base text-black font-semibold max-md:pb-2">
                {" "}
                Paperback -<span className="max-md:block">8 April 2024</span>
              </p>
              <div className="text-xs sm:text-sm 2xl:text-2xl font-semibold text-[ #757676]">
                by <span className="text-primary">{data?.author} </span>
                <span className="max-md:block">(Author)</span>
              </div>
              <div className="flex h-max items-center gap-1 sm:gap-3 gap-y-1 mt-1 flex-wrap">
                <div className="text-xs sm:text-sm 2xl:text-2xl font-bold text-black">
                  {data?.rating?.toFixed(1)}
                </div>
                <div className="flex items-center gap-1 relative group">
                  <span className="*:size-3 *:2xl:size-4 sm:*:size-4">
                ...
                {data?.no_of_ratings ? (
                  <p className="text-xs sm:text-sm 2xl:text-2xl font-semibold text-[#353C41] max-md:w-full">
                    {data?.no_of_ratings} ratings
                  </p>
                ) : (
                  ""
              ...
              {data.best_seller_rank ? (
                <div className="md:flex items-center gap-4 mt-3 md:mt-1">
                  <div className="bg-primary rounded-[4px] w-max px-2 p-1 max-md:mb-2 text-xs sm:text-sm 2xl:text-2xl font-semibold text-white">
                    # {data.best_seller_rank} Best Seller
                  </div>
                  {data?.best_seller_rank_category ? (
                    <p className="font-semibold text-black  2xl:text-xl text-xs sm:text-sm">
                      {data?.best_seller_rank_category}
                    </p>
                  ) : (
                    ""
              ...
              <div className="grid-cols-4 grid mt-4 border-2 border-l-0 border-r-0 py-6 border-[#E7DEE3] max-md:hidden">
                <div className="mx-auto">
                  <div className="w-12 aspect-[1.2] lg:aspect-[1.3] *:object-contain *:size-full  mx-auto">
                    <img src={delivery} alt="" />
                  </div>
                  <p className="text-xs 2xl:text-lg text-center font-semibold text-[#AB6D87] pt-3">
                    Free Delivery
                  </p>
                </div>
                <div className="mx-auto">
              ...
              <div className="grid grid-cols-12 gap-3 max-md:hidden mb-8">
            ...
            <div className="col-span-4 lg:col-span-3 max-md:hidden">
              <div className="border border-gray1 p-3  lg:p-4 rounded-3xl">
                {data?.prices?.length
                  ? data?.prices?.map((item) => (
                      <div
                        className={`rounded-xl p-2 lg:p-3 border-black hover:bg-yellow4 border mb-2 ${
                          selectedPackage === "1" ? "bg-yellow4" : ""
                        }`}
          ...
          <div className="grid-cols-4  my-4 border-2 border-l-0 border-r-0 py-6 border-[#E7DEE3] max-md:grid hidden">
            <div className="mx-auto">
              <div className="w-12 aspect-[1.2] lg:aspect-[1.3] *:object-contain *:size-full  mx-auto">
                <img src={delivery} alt="" />
              </div>
          ...
          <div className="py-6 max-md:block hidden">
            <div className="border border-gray1 p-3 w-full sm:w-1/2 mx-auto  lg:p-4 rounded-3xl">
              {data?.prices?.length
                ? data?.prices?.map((item) => (
                    <div
                      className={`rounded-xl p-2 lg:p-3 border-black hover:bg-yellow4 border mb-2 ${
              ...
              <div className="flex justify-between mt-6 items-start">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-semibold text-black  2xl:text-xl text-right">
                    (570.00 incl. GST)
                  </p>
                  <p className="text-sm font-semibold text-gray2 text-right">
                    M.R.P.: ₹ 770.00
                  </p>
                  <p className="text-sm font-semibold text-gray2 text-right">
                    Save: ₹ 200.00 (30%)
              ...
              <a
                href="#"
                className="bg-primary border border-primary block text-sm lg:text-base font-semibold text-center text-[#ffff] mt-8  lg:!w-full py-1 lg:py-2 rounded-full"
              >
                ADD TO CART
              </a>
              <a
                href="#"
                className=" block text-sm lg:text-base font-semibold text-center rounded-full border border-black py-1 lg:py-2 mt-3"
              >
                BUY NOW
              </a>
            </div>
